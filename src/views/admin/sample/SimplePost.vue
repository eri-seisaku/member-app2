...
import { addOneLevelSingleData, addTwoLevelSingleData } from '@/firebase/v1/firestore';
...
const submit = async () => {
  ...
  try {
    ...
    const secondDocID = await addTwoLevelSingleData(user.value.uid, postData, "portfolios", "portfolio");
